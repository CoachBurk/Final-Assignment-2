...
app.layout = html.Div([
    ...
    html.H1("Select Statistics", style={'textAlign':'center','color':'#503D36','font-size':24})
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            value='Label and user-provided values',
            placeholder='values'
        )
    ]),
...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'), Input(component_id='selected-year', component_property='values')])
